<p align="center">
  <img src="https://github.com/shindong96/woowacourse-archive/assets/70707629/5fb804fd-8cd3-4e0a-9da6-5f40b3685bae">
</p>
...
1. Level 1 : JAVA 프로그래밍 기본
    - [🎯](#level1) 미션
    - [📝](#writing) 우아한테크코스 한 달 생활기 - 우테코를 시작하며..
    
2. Level 2 : 웹 프로그래밍
    - [🎯](#level2) 미션
    - [📖](#study) 스터디 : `스프링5 프로그래밍 입문(최범균)`를 이용한 스프링 부수기
    - [📝](#writing) 우아한테크코스에서 찾은 나만의 효과적인 공부법 - 고민을 아끼지 않기
    
3. Level 3 : 팀 프로젝트
    - [✅](#level3) 체크메이트 - 출석 관리 프로젝트
    - [📝](#writing) 팀 프로젝트가 나에게 남긴 것 - 아스피의 성장기

4. Level 4 : 팀 프로젝트 유지 보수 및 웹 백엔드에 깊이를 더하는 단계
    - [🎯](#level4) 미션
    - [📝](#writing) 내가 꿈꾸는 프로그래머로서의 삶 - 우테코를 마치며..
    - [🎤](#tecotalk) 테코톡 : 정렬 알고리즘


--- 

## **🎯** Level 1 : JAVA 기반 프로그래밍 기본<a name="level1"></a>
